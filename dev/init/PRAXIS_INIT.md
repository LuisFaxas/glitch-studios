...
│   └── _executed/                  # Completed work orders
...
│   └── _executed/                  # Completed command sets
│
...
| Work orders structure | work-orders/{_executed}/ (Solo) or work-orders/wo_{agent}/{_executed}/ (Triangle) |
| Commands structure | commands/active/, commands/_executed/ |
...
5. **Items move to `_executed/` only when complete** -- Pending items stay in parent folder.
