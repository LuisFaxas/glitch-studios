...
export default function FaultyTerminal({
  ...
  // Pause handling — separate from the main setup effect
  // so toggling pause doesn't recreate the GL context
  useEffect(() => {
    pauseRef.current = pause;
    if (!pause && rendererRef.current && updateFnRef.current && rafRef.current === null) {
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      // If paused, render one final frame then stop the loop
      if (pauseRef.current) {
